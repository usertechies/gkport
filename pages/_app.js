...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Gobinda";
	const description =
		"Hello! I'm Gobinda, a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar =
		"https://res.cloudinary.com/doavrkbva/image/upload/v1725195990/kfpzcrkevxw1glninog1.jpg";
